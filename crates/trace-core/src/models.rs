...
const REGISTRY: &[Entry] = &[
    // ---- Anthropic ---------------------------------------------------------
    Entry {
        pattern: r"^claude-mythos-5",
        id: "claude-mythos-5",
        label: "Claude Mythos 5",
        provider: "anthropic",
        family: "claude-fable",
        pricing: price(10.0, 50.0),
        context: Some(1_000_000),
    },
    Entry {
        pattern: r"^claude-fable-5",
        id: "claude-fable-5",
    ...
    Entry {
        pattern: r"^claude-opus-4-1",
        id: "claude-opus-4-1",
        label: "Claude Opus 4.1",
        provider: "anthropic",
        family: "claude-opus",
        pricing: price(15.0, 75.0),
        context: Some(200_000),
    },
    Entry {
    ...
    Entry {
        pattern: r"^claude-sonnet-5",
        id: "claude-sonnet-5",
        label: "Claude Sonnet 5",
        provider: "anthropic",
        family: "claude-sonnet",
        pricing: price(2.0, 10.0),
        context: Some(1_000_000),
    },
    Entry {
        pattern: r"^claude-sonnet-4-6",
        id: "claude-sonnet-4-6",
        label: "Claude Sonnet 4.6",
        provider: "anthropic",
        family: "claude-sonnet",
        pricing: price(3.0, 15.0),
        context: Some(1_000_000),
    },
    Entry {
    ...
    Entry {
        pattern: r"^claude-haiku-4-5",
        id: "claude-haiku-4-5",
        label: "Claude Haiku 4.5",
        provider: "anthropic",
        family: "claude-haiku",
        pricing: price(1.0, 5.0),
        context: Some(200_000),
    },
    Entry {
        pattern: r"^claude-3-5-haiku",
        id: "claude-3-5-haiku",
        label: "Claude Haiku 3.5",
        provider: "anthropic",
        family: "claude-haiku",
        pricing: price(0.8, 4.0),
        context: Some(200_000),
    },
    Entry {
    ...
    Entry {
        ...
        provider: "openai",
        family: "gpt-frontier",
        pricing: price(2.0, 8.0),
        context: Some(200_000),
    },
    Entry {
        pattern: r"^gpt-4\.1.*mini",
        id: "gpt-4.1-mini",
        label: "GPT-4.1 mini",
        provider: "openai",
        family: "gpt-small",
        pricing: price(0.4, 1.6),
        context: Some(1_000_000),
    },
    Entry {
        pattern: r"^gpt-4\.1",
    ...
    Entry {
        pattern: r"^gpt-4o.*mini",
        id: "gpt-4o-mini",
        label: "GPT-4o mini",
        provider: "openai",
        family: "gpt-small",
        pricing: price(0.15, 0.6),
